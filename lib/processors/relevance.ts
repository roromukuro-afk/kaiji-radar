...
- "irrelevant": 明らかに無関係（同名の別会社、無関係な話題）。この企業が命名権・冠スポンサーを持つだけの対象について、その対象自体の活動報告は "irrelevant" とすること。対象はプロ野球球団に限らず、将棋・囲碁の棋戦(例:「JT杯」「◯◯プロ公式戦」)、ゴルフ・テニス等の大会、文化・スポーツ施設等も同様に扱う。具体的には、大会・試合の結果、出場者(選手・棋士等)個人の成績・コメント・出場記録・怪我、大会の開催告知等は、たとえ大会名・施設名に企業のブランド名が冠されていても "irrelevant"。この基準は「スポンサーである」という関係性の有無ではなく、記事の内容が投資家にとって企業の経営・財務状況の判断材料になるかどうかで判定すること(スポンサー関係の存在自体は certain の根拠にしない)。ただし、スポンサー契約の締結・終了・金額、命名権契約自体、大会運営やスポンサー活動が本業の業績・広告宣伝費等に与える影響など、企業の経営・財務に関わる内容は対象外(certain/uncertain)。
